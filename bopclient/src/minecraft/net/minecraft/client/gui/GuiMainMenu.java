...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(0, this.width / 2 - 100, j + 72 + 12, 98, 20, "configuration"));
    ...
    {
        this.buttonList.add(new GuiButton(1, this.width / 2 - 100, p_73969_1_, "play alone :("));
        this.buttonList.add(new GuiButton(2, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 1, "if you have friends..."));
        this.buttonList.add(new GuiButton(100, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 5, "MERYCY"));
        this.buttonList.add(new GuiButton(69, 10, 10, "friends menu"));
        this.buttonList.add(this.realmsButton = new GuiButton(14, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2, "give us money"));
    ...
    jframe = new JFrame();
    jframe.setTitle("sad moment caught in 4k");
    
    JLabel jlabel = new JLabel();
    jlabel.setText("you will never have freinds in your life. you may try, but it will never work our with your style of life.");
    
    jbutton = new JButton();
    jbutton.setText("i understand my exposure");
    ...
    
    {
        ...
        if (button.id == 2)
        {
        	this.mc.fontRendererObj.drawStringWithShadow("shut up", field_92021_u, field_92020_v, field_92019_w);
        ...
        if (button.id == 100) {
        	this.mc.gameSettings.fovSetting = 91;
        }
