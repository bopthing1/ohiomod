...
public class GuiFuckScreen extends GuiScreen
{
    private String field_146313_a;
    private String field_146312_f;

    public GuiFuckScreen(String p_i46319_1_, String p_i46319_2_)
    {
    ...
    {
        super.initGui();
        this.buttonList.add(new GuiButton(0, this.width / 2 - 100, 140, "ok, i understand, and i wont harm you"));
    }
