...
public class GuiEditSign extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(this.doneBtn = new GuiButton(0, this.width / 5 - 100, this.height / 4 + 120, I18n.format("gui.done", new Object[0])));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        {
            float f1 = (float)(this.tileSign.getBlockMetadata() * 160) / 16.0F;
