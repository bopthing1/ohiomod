...
{
	Object[] phrases = {"shut up idiot", "why are you so fat today? you seem ugly", "ur not even insulting me at this point"};
    ...
    public void initGui()
    {
        ...
        this.inputField = new GuiTextField(0, this.fontRendererObj, 7, this.height - 12, this.width - 4, 12);
    ...
    protected void keyTyped(char typedChar, int keyCode) throws IOException
    {
        ...
        else
        {
            ...
            if (s.length() > 0)
            {
                this.sendChatMessage(s.toLowerCase());
            }
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException
    {
        if (mouseButton == 0)
        {
        	...
        	this.mc.ingameGUI.getChatGUI().addToSentMessages("I hate you! you are so mean. I am mad at you");
        }
