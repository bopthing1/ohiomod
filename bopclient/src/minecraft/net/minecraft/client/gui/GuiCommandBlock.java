...
public class GuiCommandBlock extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.commandTextField.setCanLoseFocus(false);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.drawString(this.fontRendererObj, "sorry but mojang didnt invent this shit idea", 2, 2, j);
    ...
    private void func_175388_a()
    {
        if (this.localCommandBlock.shouldTrackOutput())
        {
            this.field_175390_s.displayString = "shut";
        ...
        {
            this.field_175390_s.displayString = "up";
            this.previousOutputTextField.setText("well u dont want anything here soooooo");
        }
    }
}
