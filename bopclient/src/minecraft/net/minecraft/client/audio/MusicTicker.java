...
public class MusicTicker implements ITickable
{
    ...
    {
        MENU(new ResourceLocation("minecraft:music.game.creative"), 20, 600),
        GAME(new ResourceLocation("minecraft:music.game"), 12000, 24000),
        CREATIVE(new ResourceLocation("minecraft:music.game.nether"), 1200, 3600),
