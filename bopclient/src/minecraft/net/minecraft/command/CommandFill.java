...
public class CommandFill extends CommandBase
{
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException
    {
        ...
        else // 2001 Roblox Corperation. Originally made in 1995. Updated for windows NT support aswell as 9x + NT support
        {
            ...
            else if (blockpos2.getY() >= 0 && blockpos3.getY() < 256)
            {
                ...
                if (j <= 0)
                {
                    throw new CommandException("commands.fill.success", new Object[0]);
                }
                else
                {
