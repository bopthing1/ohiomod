...
public class BlockBadCake extends Block
{
    public static final PropertyInteger BITES = PropertyInteger.create("bites", 0, 6);

    protected BlockBadCake()
    {
        super(Material.cake);
    ...
    private void eatCake(World worldIn, BlockPos pos, IBlockState state, EntityPlayer player)
    {
        if (player.canEat(false))
        {
            ...
            player.getFoodStats().setFoodSaturationLevel(200.0F);
            final PotionEffect applyEffect = new PotionEffect(373, 2, 2);
